...
async function main() {
  ...
  const rolesList = [
    ...
    { name: 'Accountant', isPrivileged: false, description: 'Manage charts of accounts, journals, hall bookings, donations, invoices, and financial reports (View + Add + Post to Ledger)', perms: [
      'CREATE_ACCOUNT', 'coa.post',
      'VIEW_REPORTS', 'VIEW_AUDIT', 'VIEW_JOURNALS', 'POST_JOURNAL', 'POST_LEDGER', 'journalEntries.post', 'openingBalances.post',
      'RECORD_INCOME', 'RECORD_EXPENSE', 'revenue.post', 'expenses.post',
      'VIEW_HALL_BOOKINGS', 'CREATE_HALL_BOOKING', 'hallBookings.post',
      'VIEW_DONATIONS', 'CREATE_DONATION', 'VIEW_DONATIONS_RECEIVED', 'CREATE_DONATION_RECEIVED', 'donations.post', 'revenueCollections.post',
      'VIEW_REVENUE_COLLECTIONS', 'CREATE_REVENUE_COLLECTION',
      'VIEW_INVOICES', 'CREATE_INVOICE', 'invoices.post',
      'VIEW_DONORS', 'CREATE_DONOR',
      'VIEW_CUSTOMERS', 'CREATE_CUSTOMER',
      'VIEW_ZAKAT_CARDS', 'CREATE_ZAKAT_CARD', 'zakatCards.post',
