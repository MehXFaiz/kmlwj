  ...
  return (
    <div className="min-h-[100dvh] flex flex-col lg:flex-row bg-slate-950 overflow-x-hidden">
      ...
      <div className="hidden lg:flex lg:w-[48%] xl:w-[52%] relative overflow-hidden flex-col justify-between p-10 xl:p-14 shrink-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-indigo-950/60 to-slate-900" />

        {/* Ambient glow orbs */}
        <div className="absolute top-[15%] left-[10%] w-72 h-72 bg-indigo-500/10 rounded-full blur-[100px] animate-[float_8s_ease-in-out_infinite]" />
        ...
        <div className="absolute top-[55%] left-[40%] w-48 h-48 bg-indigo-600/8 rounded-full blur-[80px] animate-[float_7s_ease-in-out_infinite_1s]" />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-3">
            ...
            />
            <div className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-gradient-to-r from-indigo-950/90 to-slate-900/80 border border-indigo-800/50 shadow-lg shadow-indigo-900/20">
              <span className="text-lg font-black tracking-[0.18em] bg-gradient-to-r from-indigo-300 via-blue-300 to-indigo-400 bg-clip-text text-transparent">KMLWJ</span>
            </div>
          </div>
          <div
            className="font-bold text-indigo-200/90 mt-2"
            style={{
        ...
        <div className="relative z-10 -mt-8">
          <h1 className="text-4xl xl:text-5xl font-black leading-[1.15] tracking-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-blue-400 to-indigo-300">
              clarity
            </span>
            <br />
        ...
        <div className="relative z-10 grid grid-cols-2 gap-3">
          {features.map(({ icon: Icon, label, desc }) => (
            <div
              key={label}
              className="flex items-start gap-3 p-3.5 rounded-xl bg-white/[0.03] border border-indigo-800/20 backdrop-blur-sm"
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500/20 to-blue-700/30 border border-indigo-500/15 flex items-center justify-center shrink-0 mt-0.5">
        ...
        <div className="w-full max-w-[420px] mx-auto px-4 sm:px-6 py-5 sm:py-8 lg:py-12 relative z-10 min-h-[100dvh] lg:min-h-0 flex flex-col justify-start sm:justify-center box-border">
          ...
          <div className="lg:hidden flex flex-col items-center justify-center mb-4 sm:mb-6 shrink-0 gap-3">
            <div className="flex items-center gap-3">
              ...
              />
              <div className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-gradient-to-r from-indigo-950/90 to-slate-900/80 border border-indigo-800/50 shadow-lg shadow-indigo-900/20">
                <span className="text-base sm:text-lg font-black tracking-[0.18em] bg-gradient-to-r from-indigo-300 via-blue-300 to-indigo-400 bg-clip-text text-transparent">KMLWJ</span>
              </div>
            </div>
            <div
              className="font-bold text-indigo-200/90 text-center"
              style={{
                fontFamily: "'Jameel Noori Nastaleeq', 'Noto Nastaliq Urdu', serif",
                fontSize: '1rem',
                lineHeight: 2,
