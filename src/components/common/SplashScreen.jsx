    ...
    >
      ...
      <div
        ...
        style={{
          width: 140,
          height: 140,
          background: 'conic-gradient(from 0deg, transparent 60%, rgba(72,47,30,0.8) 100%)',
      ...
      <div
        ...
        style={{
          width: 100,
          height: 100,
          background: 'radial-gradient(circle, rgba(72,47,30,0.35) 0%, transparent 70%)',
          filter: 'blur(8px)',
      ...
      <img
        ...
        style={{
          ...
          height: 110,
          objectFit: 'contain',
          filter: 'drop-shadow(0 0 15px rgba(72,47,30,0.5))',
        }}
      />
    </div>
  );
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      dots.forEach((d) => {
        ...
        ctx.fillStyle = `rgba(72,47,30,${Math.max(0, alpha)})`;
        ctx.fill();
      });
    ...
    >
      <div
        style={{
          ...
          right: 0,
          height: '1px',
          background: 'linear-gradient(90deg, transparent 0%, rgba(72,47,30,0.6) 40%, rgba(197,155,39,0.8) 50%, rgba(72,47,30,0.6) 60%, transparent 100%)',
          animation: 'splash-scan 3s ease-in-out infinite',
          boxShadow: '0 0 12px rgba(72,47,30,0.5)',
        }}
      />
    </div>
  );
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes splash-bar-glow {
          0%, 100% { box-shadow: 0 0 8px rgba(72,47,30,0.5); }
          50%       { box-shadow: 0 0 20px rgba(72,47,30,0.8), 0 0 40px rgba(197,155,39,0.3); }
        }
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div style={{
            ...
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(72,47,30,0.12) 0%, transparent 70%)',
            filter: 'blur(40px)',
        ...
        <div className="relative z-10 flex flex-col items-center gap-0 select-none px-6 sm:px-0" style={{ width: '100%', maxWidth: 420 }}>
          ...
          >
            <span style={{
              ...
              color: '#fdf8f5',
              background: 'rgba(72,47,30,0.12)',
              border: '1px solid rgba(72,47,30,0.25)',
            }}>
              <span style={{
          ...
          <div style={{
            width: '100%',
            height: 1,
            background: 'linear-gradient(90deg, transparent, rgba(72,47,30,0.4), rgba(197,155,39,0.3), transparent)',
            marginTop: 36,
            marginBottom: 28,
          ...
          >
            ...
            <div style={{
              ...
              <span style={{
                ...
                <span style={{
                  ...
                  height: 7,
                  borderRadius: '50%',
                  background: progress < 100 ? '#482F1E' : '#34d399',
                  animation: progress < 100 ? 'splash-blink 0.8s ease-in-out infinite' : 'none',
                  boxShadow: '0 0 8px rgba(72,47,30,0.8)',
                }} />
                {stepLabel}
              </span>
              <span style={{
            ...
            <div style={{
              ...
              border: '1px solid rgba(72,47,30,0.15)',
              overflow: 'hidden',
            }}>
              {/* Fill */}
              <div style={{
                ...
                background: progress < 100
                  ? 'linear-gradient(90deg, #1C120B, #64432C, #CFAEA0)'
                ...
                <div
                  ...
                  style={{
                    ...
                    background: i <= stepIndex
                      ? (i === stepIndex ? '#482F1E' : '#291A10')
                      : 'rgba(51,65,85,0.5)',
                    transform: i === stepIndex ? 'scale(1.5)' : 'scale(1)',
                    boxShadow: i === stepIndex ? '0 0 10px rgba(72,47,30,0.9)' : 'none',
                    border: i <= stepIndex ? '1px solid rgba(72,47,30,0.5)' : '1px solid rgba(51,65,85,0.3)',
                  }}
                />
              ))}
            </div>
        ...
        {[
          ...
          <div key={i} style={{
            ...
            width: 20,
            height: 20,
            borderColor: 'rgba(72,47,30,0.25)',
            borderStyle: 'solid',
            borderWidth: 0,
