    ...
    <header className="h-16 bg-slate-900 border-b border-slate-800/80 flex items-center justify-between px-6 z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider hidden sm:inline">Entity:</span>
          <select
            value={selectedSubsidiary}
            onChange={(e) => setSelectedSubsidiary(e.target.value)}
            className="bg-slate-950/60 border border-slate-800 text-xs font-semibold text-slate-200 py-1.5 px-3 rounded-md focus:outline-none focus:ring-1 focus:ring-brand-500/50 cursor-pointer"
          >
