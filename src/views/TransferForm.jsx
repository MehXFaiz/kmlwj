          ...
          <div className="lg:col-span-4 space-y-5">
            <div className="bg-amber-500/5 rounded-2xl border border-amber-500/20 p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-amber-300">Transfer Guidelines</h3>
              </div>
            ...
            <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden">
              ...
              <div className="p-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
                  ...
                  <div className="hidden sm:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-slate-800 border border-slate-700 items-center justify-center text-amber-400 z-10">
