...
export const donorService = {
  ...
  delete: (id) => api.delete(`/api/v1/donors?id=${id}&permanent=true`).then(res => res.data),
  bulkDelete: (ids) => api.delete('/api/v1/donors/bulk-delete', { data: { ids } }).then(res => res.data),
};
