...
export const memberService = {
  ...
  delete: (id) => api.delete(`/api/v1/members?id=${id}&permanent=true`).then(res => res.data),
  bulkDelete: (ids) => api.delete('/api/v1/members', { data: { ids, permanent: true } }).then(res => res.data),
