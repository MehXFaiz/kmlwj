...
// SYSTEM_SETTINGS. These define the "Super Admin" security boundary — enforced
// by permission set, never by a role's literal name. A role is treated as
// security-sensitive if it grants ANY of these.
