...
import summaryHandler from './_v1/dashboard/summary.js';
...
app.get('/api/dashboard/summary', makeExpress(summaryHandler));
app.get('/api/v1/dashboard/summary', makeExpress(summaryHandler));
